...
<body>
    <div class="invoice-container">
        ...
        <div class="address-section">
            ...
            <p><strong>رقم العقار:</strong> ${propertyNumber}</p>
              ...
              {showDeliveryCheckout && (
                <div className="space-y-4 max-h-96 overflow-y-auto cart-scrollbar pr-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="block text-sm font-medium mb-1 text-right">رقم العقار *</label>
                      <Input

...
const DomsPencilsPage = () => {
  const { addItem } = useCart();
  
  useEffect(() => {
    document.title = "أقلام Doms | تفانين";
    const desc = "تسوق أقلام Doms عالية الجودة - مجموعة متنوعة من أقلام الرصاص للكتابة والرسم من تفانين.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-foreground">أقلام Doms</span>
        </nav>
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-4">
            جودة هندية مميزة بأسعار تنافسية - الخيار الأمثل للطلاب
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 bg-muted/30 rounded-2xl p-6">
          ...
          <div className="text-center">
            <div className="text-3xl mb-2">🏭</div>
            <h3 className="font-semibold mb-1">صناعة هندية</h3>
            <p className="text-sm text-muted-foreground">منتج عالي الجودة بأسعار معقولة</p>
          </div>
          <div className="text-center">
            <div className="text-3xl mb-2">💰</div>
            <h3 className="font-semibold mb-1">قيمة ممتازة</h3>
            <p className="text-sm text-muted-foreground">جودة عالية بأسعار منافسة</p>
          </div>
        </div>

        {/* Products Grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {domsPencils.map((pencil) => (
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto mb-6">
            Doms هي علامة تجارية هندية رائدة في مجال أدوات الكتابة والقرطاسية.
            تشتهر منتجاتها بالجودة العالية والتصميم العملي والأسعار التنافسية.
            تقدم Doms مجموعة واسعة من أقلام الرصاص التي تلبي احتياجات الطلاب والفنانين في جميع أنحاء العالم.
          </p>
...
export default DomsPencilsPage;

...
const Krassat28PagesPage = () => {
  ...
  const notebookTypes = [
    ...
    },
    {
      ...
      link: "/notebooks/krassat/28-pages/9-lines"
    },
    {
      id: 3,
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كراسات 28 ورقة</h1>
...
export default Krassat28PagesPage;

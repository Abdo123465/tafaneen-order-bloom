...
const kashakil60LargeSquaresDisneyItems = [
  {
    id: "kash60-lsq-dis-1",
    name: "كشكول 60 ورقة مربعات كبيرة ديزني",
    price: 20,
    image: "/assets/kash60-lsq-dis-princess.jpg",
...
const Kashakil60LargeSquaresDisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة مربعات كبيرة ديزني | تفانين";
    const desc = "احصل على كشاكيل مربعات كبيرة 60 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة مربعات كبيرة ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil60LargeSquaresDisneyItems.map((item) => (
...
export default Kashakil60LargeSquaresDisneyPage;

// src/pages/Kashakil100EnglishNormalPage.tsx
...
const kashakil100EnglishNormalItems = [
  {
    id: "kash100-eng-nor-1",
    name: "كشكول 100 ورقة انجليزي عادي",
    price: 15,
    image: "/assets/kash100-eng-nor-blue.jpg",
    description: "كشكول انجليزي 100 ورقة، غلاف لامع بسيط، ورق 48 جرام، مناسب للكتابة الإنجليزية.",
    brand: "محلي",
    pages: 100,
    size: "22×16 سم",
    paperWeight: "48 جرام",
  ...
  {
    id: "kash100-eng-nor-2",
    name: "كشكول 100 ورقة انجليزي أحمر",
    price: 15,
    image: "/assets/kash100-eng-nor-red.jpg",
    description: "كشكول انجليزي 100 ورقة، غلاف أحمر لامع، ورق 48 جرام، مناسب للكتابة الإنجليزية.",
    brand: "محلي",
    pages: 100,
    size: "22×16 سم",
    paperWeight: "48 جرام",
  ...
  {
    id: "kash100-eng-nor-3",
    name: "كشكول 100 ورقة انجليزي أسود",
    price: 15,
    image: "/assets/kash100-eng-nor-black.jpg",
    description: "كشكول انجليزي 100 ورقة، غلاف أسود لامع، ورق 48 جرام، مناسب للكتابة الإنجليزية.",
    brand: "محلي",
    pages: 100,
    size: "22×16 سم",
    paperWeight: "48 جرام",
...
const Kashakil100EnglishNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 100 ورقة انجليزي عادي | تفانين";
    const desc = "كشاكيل انجليزي 100 ورقة بأغلفة بسيطة ومناسبة للكتابة الإنجليزية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <Link to="/notebooks/kashakil/100-pages/english" className="hover:text-primary">كراسة انجليزي</Link>
          <ArrowRight className="h-4 w-4" />
        ...
        <div className="text-center mb-12">
          <img
            src="/assets/english-normal-cover-banner.jpg"
            alt="English Normal Cover"
            className="mx-auto h-40 object-cover rounded-xl mb-4 shadow"
            onError={(e) => (e.currentTarget.src = "https://via.placeholder.com/600x160?text=انجليزي عادي")}
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 100 ورقة انجليزي عادي</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            كشاكيل اقتصادية بأغلفة بسيطة ومناسبة للكتابة الإنجليزية
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil100EnglishNormalItems.map((item) => (
        ...
        <div className="text-center mt-12">
          <Button asChild variant="outline">
            <Link to="/notebooks/kashakil/100-pages/english">العودة إلى كراسة انجليزي</Link>
          </Button>
        </div>
      </main>
      <Footer />
...
export default Kashakil100EnglishNormalPage;

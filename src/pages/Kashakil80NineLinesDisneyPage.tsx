...
const kashakil80NineLinesDisneyItems = [
  {
...
const Kashakil80NineLinesDisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 80 ورقة 9 أسطر ديزني | تفانين";
    const desc = "احصل على كشاكيل 9 أسطر 80 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 80 ورقة 9 أسطر ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil80NineLinesDisneyItems.map((item) => (
...
export default Kashakil80NineLinesDisneyPage;

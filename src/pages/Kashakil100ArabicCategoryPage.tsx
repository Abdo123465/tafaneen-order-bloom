// src/pages/Kashakil100ArabicCategoryPage.tsx
...
const Kashakil100ArabicCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 100 ورقة عربي | تفانين";
    const desc = "اختر كشكول عربي 100 ورقة المناسب لك من مجموعة متنوعة من الأنواع.";
  ...
  const notebookTypes = [
    {
      id: 1,
      name: "كراسات عادية",
      description: "كشاكيل عربي 100 ورقة بأغلفة بسيطة وأسعار اقتصادية",
      icon: Languages,
    ...
    },
    {
      id: 2,
      name: "كراسات ديزني",
      description: "كشاكيل عربي 100 ورقة بتصاميم ديزني المحببة للأطفال",
      icon: Languages,
        ...
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            <nav className="text-sm text-muted-foreground mb-4">
              ...
              <span className="mx-2">/</span>
              <span>كراسة عربي</span>
            </nav>
            
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل 100 ورقة عربي</h1>
...
export default Kashakil100ArabicCategoryPage;

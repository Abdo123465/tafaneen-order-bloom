// src/pages/Kashakil60PageByPageDisneyPage.tsx
...
const kashakil60PageByPageDisneyItems = [
  {
    id: "kash60-pbp-dis-1",
    name: "كشكول 60 ورقة صفحة وصفحة ديزني",
    price: 20,
    image: "/assets/kash60-pbp-dis-princess.jpg",
    description: "كشكول صفحة وصفحة 60 ورقة، غلاف أميرات ديزني ملون، أو سيارات أو ميكي ماوس، ورق 60 جرام.",
    brand: "Disney",
    pages: 60,
    size: "21×29.7 سم",
    paperWeight: "60 جرام",
...
const Kashakil60PageByPageDisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة صفحة وصفحة ديزني | تفانين";
    const desc = "احصل على كشاكيل صفحة وصفحة 60 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <Link to="/notebooks/kashakil/60-pages/page-by-page" className="hover:text-primary">كراسة صفحة وصفحة</Link>
            <ArrowRight className="h-4 w-4" />
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة صفحة وصفحة ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil60PageByPageDisneyItems.map((item) => (
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline">
              <Link to="/notebooks/kashakil/60-pages/page-by-page">العودة إلى كراسة صفحة وصفحة</Link>
            </Button>
          </div>
        </main>
      </div>
...
export default Kashakil60PageByPageDisneyPage;

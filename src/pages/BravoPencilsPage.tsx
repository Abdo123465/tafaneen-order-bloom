// src/pages/BravoPencilsPage.tsx
...
const BravoPencilsPage = () => {
  const { addItem } = useCart();
  
  useEffect(() => {
    document.title = "أقلام برافو | تفانين";
    const desc = "تسوق أقلام برافو عالية الجودة - مجموعة متنوعة من أقلام الرصاص للكتابة والرسم من تفانين.";
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-4">
            جودة برازيلية مميزة بأسعار تنافسية - الخيار الأمثل للطلاب والفنانين
          </p>
          <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full">
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <span className="text-sm font-medium">صنع في البرازيل</span>
          </div>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">عن برافو</h2>
          <p className="text-muted-foreground max-w-3xl mx-auto mb-6">
            برافو هي علامة تجارية برازيلية رائدة في مجال أدوات الكتابة والقرطاسية.
            تشتهر منتجاتها بالجودة العالية والتصميم العملي والأسعار التنافسية.
            تقدم برافو مجموعة واسعة من أقلام الرصاص التي تلبي احتياجات الطلاب والفنانين في جميع أنحاء العالم.
          </p>
          <div className="flex items-center justify-center gap-8 text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
              <span>صنع في البرازيل</span>
            </div>
            <div className="flex items-center gap-2">
...
export default BravoPencilsPage;

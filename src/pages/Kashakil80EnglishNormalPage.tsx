// src/pages/Kashakil80EnglishNormalPage.tsx
...
const kashakil80EnglishNormalItems = [
  {
    id: "kash80-eng-nor-1",
    name: "كشكول 80 ورقة انجليزي عادي",
    price: 15,
    image: "/assets/kash80-eng-nor-blue.jpg",
    description: "كشكول انجليزي 80 ورقة، غلاف لامع بسيط، ورق 48 جرام.",
    brand: "محلي",
    pages: 80,
    size: "21×15 سم",
    paperWeight: "48 جرام",
...
const Kashakil80EnglishNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 80 ورقة انجليزي عادي | تفانين";
    const desc = "كشاكيل انجليزي 80 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 80 ورقة انجليزي عادي</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil80EnglishNormalItems.map((item) => (
...
export default Kashakil80EnglishNormalPage;

...
const EnglishDisney28Page = () => {
  ...
  useEffect(() => {
    document.title = "كراسات إنجليزي ديزني 28 ورقة | تفانين";
    const desc = "احصل على كراسات الإنجليزي 28 ورقة بتصاميم ديزني المميزة.";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/assets/en-disney-bg.jpg')" }}
      >
        <main className="container mx-auto px-4 py-10">
          <nav className="flex items-center gap-2 text-sm text-white/80 mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <span className="text-white font-medium">إنجليزي ديزني</span>
          </nav>

          <div className="text-center mb-12">
            <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-white drop-shadow">كراسات إنجليزي ديزني – 28 ورقة</h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto drop-shadow">اختر كراستك المفضلة بتصميمات ديزني المحببة للأطفال</p>
          </div>

// src/pages/Kashakil60SmallSquaresNormalPage.tsx
...
const kashakil60SmallSquaresNormalItems = [
  {
    id: "kash60-ssq-nor-1",
...
const Kashakil60SmallSquaresNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة مربعات صغيرة عادي | تفانين";
    const desc = "كشاكيل مربعات صغيرة 60 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة مربعات صغيرة عادي</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil60SmallSquaresNormalItems.map((item) => (
...
export default Kashakil60SmallSquaresNormalPage;

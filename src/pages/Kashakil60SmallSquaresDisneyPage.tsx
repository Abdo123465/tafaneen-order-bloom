// src/pages/Kashakil60SmallSquaresDisneyPage.tsx
...
const kashakil60SmallSquaresDisneyItems = [
  {
    id: "kash60-ssq-dis-1",
...
const Kashakil60SmallSquaresDisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة مربعات صغيرة ديزني | تفانين";
    const desc = "احصل على كشاكيل مربعات صغيرة 60 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <Link to="/notebooks/kashakil/60-pages/small-squares" className="hover:text-primary">كراسة مربعات صغيرة</Link>
            <ArrowRight className="h-4 w-4" />
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة مربعات صغيرة ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil60SmallSquaresDisneyItems.map((item) => (
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline">
              <Link to="/notebooks/kashakil/60-pages/small-squares">العودة إلى كراسة مربعات صغيرة</Link>
            </Button>
          </div>
        </main>
      </div>
...
export default Kashakil60SmallSquaresDisneyPage;

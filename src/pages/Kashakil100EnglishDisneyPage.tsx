// src/pages/Kashakil100EnglishDisneyPage.tsx
...
const kashakil100EnglishDisneyItems = [
  {
...
const Kashakil100EnglishDisneyPage = () => {
  ...
  useEffect(() => {
    document.title = "كشاكيل 100 ورقة انجليزي ديزني | تفانين";
    const desc = "احصل على كشاكيل انجليزي 100 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 100 ورقة انجليزي ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil100EnglishDisneyItems.map((item) => (
...
export default Kashakil100EnglishDisneyPage;

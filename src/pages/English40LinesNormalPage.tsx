...
const English40LinesNormalPage = () => {
  ...
  useEffect(() => {
    document.title = "كراسه 9 أسطر عادي - 40 ورقة | تفانين";
    ...
    <div className="min-h-screen bg-background">
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <Link to="/notebooks/krassat/40-pages/9-lines" className="hover:text-primary">9 أسطر</Link>
          <ArrowRight className="h-4 w-4" />
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسات 9 أسطر عادي – 40 ورقة</h1>

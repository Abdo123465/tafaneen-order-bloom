// src/pages/English40LinesNormalPage.tsx
...
const englishNormalItems = [
  {
    ...
    price: 12,
    image: "/assets/english-normal-9-blue.jpg", // Using same image as placeholder
...
const English40LinesNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كراسه 9 ق عادي - 40 ورقة | تفانين";
    const desc = "احصل على كراسة عادي 9 أسطر 40 ورقة.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-primary font-medium">عادي</span>
        </nav>

        <div className="text-center mb-12">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسه 9 ق عادي - 40 ورقة</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">كراسة عادي 9 أسطر 40 ورقة بألوان مختلفة</p>
        </div>
...
export default English40LinesNormalPage;

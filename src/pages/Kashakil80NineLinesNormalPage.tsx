// src/pages/Kashakil80NineLinesNormalPage.tsx
...
const kashakil80NineLinesNormalItems = [
  {
    id: "kash80-9lines-nor-1",
    name: "كشكول 80 ورقة 9 أسطر عادي",
    price: 15,
    image: "/assets/kash80-9lines-nor-blue.jpg",
    description: "كشكول 9 أسطر 80 ورقة، غلاف لامع بسيط، ورق 48 جرام.",
    brand: "محلي",
    pages: 80,
    size: "21×15 سم",
    paperWeight: "48 جرام",
...
const Kashakil80NineLinesNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 80 ورقة 9 أسطر عادي | تفانين";
    const desc = "كشاكيل 9 أسطر 80 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <Link to="/notebooks/kashakil/80-pages/9-lines" className="hover:text-primary">كراسة 9 أسطر</Link>
          <ArrowRight className="h-4 w-4" />
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 80 ورقة 9 أسطر عادي</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil80NineLinesNormalItems.map((item) => (
        ...
        <div className="text-center mt-12">
          <Button asChild variant="outline">
            <Link to="/notebooks/kashakil/80-pages/9-lines">العودة إلى كراسة 9 أسطر</Link>
          </Button>
        </div>
      </main>
      <Footer />
...
export default Kashakil80NineLinesNormalPage;

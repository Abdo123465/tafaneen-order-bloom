...
const CansonPaperPage = () => {
  useEffect(() => {
    ...
    const desc = "تسوق ورق كانسون بأفضل الأنواع - A4 و 70×50. ورق كانسون عالي الجودة للرسم والتلوين من تفانين.";
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ورق كانسون عالي الجودة للرسم والتلوين بجميع المقاسات
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
            ...
            <p className="text-sm text-blue-600">سطح مثالي للرسم والتلوين</p>
          </Card>
          <Card className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            <div className="text-4xl mb-4">📐</div>
            <h3 className="font-bold mb-2 text-green-700">مقاسات متنوعة</h3>
            <p className="text-sm text-green-600">متوفر بمقاسات A4 و 70×50</p>
          </Card>
          <Card className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
            <div className="text-4xl mb-4">🎨</div>
            <h3 className="font-bold mb-2 text-purple-700">للفنانين</h3>
            <p className="text-sm text-purple-600">مثالي للفنانين والهواة</p>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
              ...
              <CardContent className="p-0 h-full">
                <div className="relative h-64 bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                    <div className="text-white">
                      ...
                      <p className="text-sm opacity-90">المقاس القياسي للرسم</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <p className="text-muted-foreground mb-4">
                    ورق كانسون بمقاس A4 المثالي للرسم والتلوين
                  </p>
          ...
          <Card className="group hover:shadow-elegant transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            <Link to="/cutting-pasting-tools/canson-paper/70x50" className="block hover:no-underline h-full">
              <CardContent className="p-0 h-full">
                ...
                <div className="p-6">
                  <p className="text-muted-foreground mb-4">
                    ورق كانسون بمقاس 70×50 سم المثالي للمشاريع الفنية الكبيرة
                  </p>
          ...
          <Card className="group hover:shadow-elegant transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            <Link to="/cutting-pasting-tools/canson-paper/sketch" className="block hover:no-underline h-full">
              <CardContent className="p-0 h-full">
                <div className="relative h-64 bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                    <div className="text-white">
                      <h3 className="font-bold text-2xl mb-1">سكتش كانسون</h3>
                      <p className="text-sm opacity-90">للرسم والتلوين</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  <p className="text-muted-foreground mb-4">
                    سكتش كانسون عالي الجودة للرسم والتلوين بألوان وأبيض
                  </p>

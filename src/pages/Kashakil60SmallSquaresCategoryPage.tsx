// src/pages/Kashakil60SmallSquaresCategoryPage.tsx
...
const Kashakil60SmallSquaresCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 60 ورقة مربعات صغيرة | تفانين";
    const desc = "اختر بين كشاكيل مربعات صغيرة عادي أو ديزني - 60 ورقة.";
  ...
  const categories = [
    {
      ...
      path: "/notebooks/kashakil/60-pages/small-squares/normal"
    },
    {
      id: 2,
      name: "ديزني",
      ...
      path: "/notebooks/kashakil/60-pages/small-squares/disney"
    }
  ];
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل 60 ورقة - كراسة مربعات صغيرة</h1>
...
export default Kashakil60SmallSquaresCategoryPage;

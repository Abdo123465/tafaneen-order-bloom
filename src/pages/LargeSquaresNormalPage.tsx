...
const LargeSquaresNormalPage = () => {
  ...
  useEffect(() => {
    document.title = "كراسات مربعات كبيرة عادي 28 ورقة | تفانين";
    const desc = "كراسات مربعات كبيرة 28 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسات مربعات كبيرة عادي – 28 ورقة</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            كراسات مربعات كبيرة اقتصادية بأغلفة بسيطة ومناسبة للاستخدام اليومي
          </p>
        </div>
...
export default LargeSquaresNormalPage;

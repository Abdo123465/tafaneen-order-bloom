// src/pages/English40NormalPage.tsx
...
const English40NormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كراسات إنجليزي عادي 40 ورقة | تفانين";
    const desc = "كراسات إنجليزي 40 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسات إنجليزي عادي – 40 ورقة</h1>
...
export default English40NormalPage;

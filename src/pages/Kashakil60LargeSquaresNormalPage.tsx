// src/pages/Kashakil60LargeSquaresNormalPage.tsx
...
const kashakil60LargeSquaresNormalItems = [
  {
    id: "kash60-lsq-nor-1",
    name: "كشكول 60 ورقة مربعات كبيرة عادي",
    price: 12,
    image: "/assets/kash60-lsq-nor-blue.jpg",
    description: "كشكول مربعات كبيرة 60 ورقة، غلاف لامع بسيط، ورق 48 جرام.",
    brand: "محلي",
    pages: 60,
    size: "21×15 سم",
    paperWeight: "48 جرام",
...
const Kashakil60LargeSquaresNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة مربعات كبيرة عادي | تفانين";
    const desc = "كشاكيل مربعات كبيرة 60 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <Link to="/notebooks/kashakil/60-pages/large-squares" className="hover:text-primary">كراسة مربعات كبيرة</Link>
          <ArrowRight className="h-4 w-4" />
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة مربعات كبيرة عادي</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil60LargeSquaresNormalItems.map((item) => (
        ...
        <div className="text-center mt-12">
          <Button asChild variant="outline">
            <Link to="/notebooks/kashakil/60-pages/large-squares">العودة إلى كراسة مربعات كبيرة</Link>
          </Button>
        </div>
      </main>
    </div>
...
export default Kashakil60LargeSquaresNormalPage;

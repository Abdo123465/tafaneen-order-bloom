...
const LargeSquares40DisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كراسات مربعات كبيرة ديزني - 40 ورقة | تفانين";
    const desc = "احصل على كراسات مربعات كبيرة 40 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسات مربعات كبيرة ديزني – 40 ورقة</h1>
...
export default LargeSquares40DisneyPage;

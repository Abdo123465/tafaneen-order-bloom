...
const English28CategoryPage = () => {
  useEffect(() => {
    document.title = "كراسات إنجليزي 28 ورقة | تفانين";
    const desc = "اختر بين كراسات إنجليزي عادية أو ديزني 28 ورقة";
  ...
  const englishTypes = [
    {
      ...
      link: "/notebooks/krassat/28-pages/english/normal"
    },
    {
      id: 2,
      ...
      link: "/notebooks/krassat/28-pages/english/disney"
    }
  ];
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كراسات إنجليزي 28 ورقة</h1>
...
export default English28CategoryPage;

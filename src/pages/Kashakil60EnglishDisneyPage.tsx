// src/pages/Kashakil60EnglishDisneyPage.tsx
...
const kashakil60EnglishDisneyItems = [
  {
    id: "kash60-en-dis-1",
    name: "كشكول 60 ورقة إنجليزي ديزني",
    price: 17,
    image: "/assets/kash60-en-dis-princess.jpg",
    description: "كشكول إنجليزي 60 ورقة، غلاف أميرات ديزني ملون، أو سيارات أو ميكي ماوس، ورق 60 جرام.",
    brand: "Disney",
    pages: 60,
    size: "22.5×16 سم",
    paperWeight: "60 جرام",
...
const Kashakil60EnglishDisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة إنجليزي ديزني | تفانين";
    const desc = "احصل على كشاكيل الإنجليزي 60 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <Link to="/notebooks/kashakil/60-pages/english" className="hover:text-primary">كراسة إنجليزي</Link>
            <ArrowRight className="h-4 w-4" />
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة إنجليزي ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil60EnglishDisneyItems.map((item) => (
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline">
              <Link to="/notebooks/kashakil/60-pages/english">العودة إلى كراسة إنجليزي</Link>
            </Button>
          </div>
        </main>
      </div>
...
export default Kashakil60EnglishDisneyPage;

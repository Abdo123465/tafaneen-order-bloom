// src/pages/Kashakil60PageByPageCategoryPage.tsx
...
const Kashakil60PageByPageCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 60 ورقة صفحة وصفحة | تفانين";
    const desc = "اختر بين كشاكيل صفحة وصفحة عادي أو ديزني - 60 ورقة.";
  ...
  const categories = [
    {
      ...
      path: "/notebooks/kashakil/60-pages/page-by-page/normal"
    },
    {
      id: 2,
      name: "ديزني",
      ...
      path: "/notebooks/kashakil/60-pages/page-by-page/disney"
    }
  ];
        ...
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-4">
              ...
              <ArrowRight className="h-4 w-4" />
              <span>كراسة صفحة وصفحة</span>
            </nav>
            
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل 60 ورقة - كراسة صفحة وصفحة</h1>
...
export default Kashakil60PageByPageCategoryPage;

...
import RoxiMytechImage from "@/assets/Roxi-My-tech.jpg";
...
const roxiPens = [
  ...
  { id: 'Roxi-My-tech', name: 'قلم روكسي ماي تك  أزرق', price: 7, image: RoxiMytechImage, description: 'قلم حبر سائل 0.7 مم لكتابة ناعمة ودقيقة' },

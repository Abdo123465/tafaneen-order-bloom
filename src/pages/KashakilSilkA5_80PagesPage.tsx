...
const KashakilSilkA5_80PagesPage = () => {
  const { addToCart } = useCart();
  const { toast } = useToast();

  useEffect(() => {
    document.title = "كشاكيل سلك A5 - 80 ورقة | تفانين";
    const desc = "كشاكيل سلك بحجم A5 - 80 ورقة بأنواع مختلفة";
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل سلك A5 - 80 ورقة</h1>
            <p className="text-muted-foreground mb-8">
              مجموعة متنوعة من كشاكيل السلك بحجم A5 بـ 80 ورقة
            </p>
          </div>
...
export default KashakilSilkA5_80PagesPage;

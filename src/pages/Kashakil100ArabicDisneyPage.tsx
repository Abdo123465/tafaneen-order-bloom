// src/pages/Kashakil100ArabicDisneyPage.tsx
...
const kashakil100ArabicDisneyItems = [
  {
    id: "kash100-arb-dis-1",
    name: "كشكول 100 ورقة عربي ديزني",
    price: 25,
    image: "/assets/kash100-arb-dis-princess.jpg",
    description: "كشكول عربي 100 ورقة، غلاف أميرات ديزني ملون، ورق 60 جرام.",
    brand: "Disney",
    pages: 100,
    size: "22.5×16 سم",
    paperWeight: "60 جرام",
  ...
  {
    id: "kash100-arb-dis-2",
    name: "كشكول 100 ورقة عربي ديزني",
    price: 25,
    image: "/assets/kash100-arb-dis-cars.jpg",
    description: "كشكول عربي 100 ورقة، غلف سيارات ديزني ملون، ورق 60 جرام.",
    brand: "Disney",
    pages: 100,
    size: "22.5×16 سم",
    paperWeight: "60 جرام",
  ...
  {
    id: "kash100-arb-dis-3",
    name: "كشكول 100 ورقة عربي ديزني",
    price: 25,
    image: "/assets/kash100-arb-dis-mickey.jpg",
    description: "كشكول عربي 100 ورقة، غلاف ميكي ماوس ملون، ورق 60 جرام.",
    brand: "Disney",
    pages: 100,
    size: "22.5×16 سم",
    paperWeight: "60 جرام",
...
const Kashakil100ArabicDisneyPage = () => {
  ...
  useEffect(() => {
    document.title = "كشاكيل 100 ورقة عربي ديزني | تفانين";
    const desc = "احصل على كشاكيل عربي 100 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 100 ورقة عربي ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil100ArabicDisneyItems.map((item) => (
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline">
              <Link to="/notebooks/kashakil/100-pages">العودة إلى كشاكيل 100 ورقة</Link>
            </Button>
          </div>
        </main>
      </div>
...
export default Kashakil100ArabicDisneyPage;

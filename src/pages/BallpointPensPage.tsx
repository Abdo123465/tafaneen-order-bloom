  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mb-12 group hover:shadow-elegant transition-all duration-300 hover:-translate-y-1 border-0 overflow-hidden bg-gradient-to-br from-blue-500 to-indigo-600 text-white">
            ...
            <CardContent className="p-6 flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-white/90">
                  أقلام برافو عالية الجودة للكتابة العادية والمريحة
                </p>
              </div>

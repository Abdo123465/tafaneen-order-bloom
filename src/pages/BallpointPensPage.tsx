  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mb-12 group hover:shadow-elegant transition-all duration-300 hover:-translate-y-1 border-0 overflow-hidden bg-gradient-to-br from-sky-500 to-blue-600 text-white">
...
ملف: src/pages/FransawyPensPage.tsx
...
const fransawyPens = [
  ...
  { id: 'fransawy-3', name: 'قلم فرنساوي كلاسيك أسود', price: 15, image: fransawyBlackImage, description: 'قلم فرنساوي كلاسيك عالي الجودة باللون الأسود للكتابة الفاخرة' },
  { id: 'fransawy-4', name: 'قلم فرنساوي كلاسيك أخضر', price: 15, image: fransawyBlueImage, description: 'قلم فرنساوي كلاسيك عالي الجودة باللون الأخضر للكتابة الفاخرة' },
  { id: 'fransawy-5', name: 'قلم فرنساوي ديلوكس أزرق', price: 25, image: fransawyBlueImage, description: 'قلم فرنساوي ديلوكس فاخر باللون الأزرق مع تصميم معدني' },
  { id: 'fransawy-6', name: 'قلم فرنساوي ديلوكس أسود', price: 25, image: fransawyBlackImage, description: 'قلم فرنساوي ديلوكس فاخر باللون الأسود مع تصميم معدني' },
  { id: 'fransawy-7', name: 'مجموعة أقلام فرنساوي ملونة', price: 70, image: fransawyRedImage, description: 'مجموعة متنوعة من أقلام فرنساوي بألوان مختلفة - 6 قطع' },
  { id: 'fransawy-8', name: 'قلم فرنساوي جولد إديشن', price: 35, image: fransawyBlueImage, description: 'قلم فرنساوي إصدار ذهبي فاخر للمناسبات الخاصة' },
  { id: 'fransawy-9', name: 'قلم فرنساوي سيلفر إديشن', price: 35, image: fransawyBlackImage, description: 'قلم فرنساوي إصدار فضي فاخر للمناسبات الخاصة' },
  { id: 'fransawy-10', name: 'قلم فرنساوي إكزكيوتيف', price: 45, image: fransawyRedImage, description: 'قلم فرنساوي تنفيذي فاخر للمدراء والمحترفين' },
];

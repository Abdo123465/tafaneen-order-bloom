// src/pages/Kashakil80EnglishCategoryPage.tsx
...
const Kashakil80EnglishCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 80 ورقة انجليزي | تفانين";
    const desc = "اختر بين كشاكيل انجليزي 80 ورقة عادي أو ديزني.";
  ...
  const categories = [
    {
      ...
      icon: BookOpen,
      path: "/notebooks/kashakil/80-pages/english/normal",
    ...
    },
    {
      ...
      icon: Sparkles,
      path: "/notebooks/kashakil/80-pages/english/disney",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-foreground">كراسة انجليزي</span>
        </nav>

        <div className="text-center mb-12">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 80 ورقة انجليزي</h1>
...
export default Kashakil80EnglishCategoryPage;

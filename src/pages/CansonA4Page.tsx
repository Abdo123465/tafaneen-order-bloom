...
const CansonA4Page = () => {
  ...
  useEffect(() => {
    document.title = "ورق كانسون A4 | تفانين";
    const desc = "تسوق ورق كانسون A4 بأوزان مختلفة - 160 جرام، 200 جرام، 250 جرام. ورق كانسون عالي الجودة للرسم والفنون من تفانين.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-foreground">ورق كانسون A4</span>
        </nav>
        
        <div className="text-center mb-12">
          <div className="text-6xl mb-4">📄</div>
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">ورق كانسون A4</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            ورق كانسون بمقاس A4 بأوزان مختلفة لجميع الاستخدامات الفنية
          </p>
        </div>
        ...
        <h2 className="text-2xl lg:text-3xl font-bold mb-8 text-center border-b pb-4">
          ...
          جميع منتجات ورق كانسون A4
        </h2>
        
        {/* Products Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cansonA4Products.map((product) => (

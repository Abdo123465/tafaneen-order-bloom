// src/pages/PrimaPencilsPage.tsx
...
const PrimaPencilsPage = () => {
  const { addItem } = useCart();
  
  useEffect(() => {
    document.title = "أقلام Prima | تفانين";
    const desc = "تسوق أقلام Prima عالية الجودة - مجموعة متنوعة من أقلام الرصاص للكتابة والرسم من تفانين.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-foreground">أقلام Prima</span>
        </nav>
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-red-600 to-pink-600 bg-clip-text text-transparent">
            أقلام Prima
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-4">
            جودة إيطالية فاخرة بتصميم أنيق - الخيار المفضل للمحترفين
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 bg-muted/30 rounded-2xl p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">خشب فاخر ورصاص نقي عالي الجودة</p>
          </div>
          <div className="text-center">
            <div className="text-3xl mb-2">📐</div>
            <h3 className="font-semibold mb-1">دقة فائقة</h3>
        ...
        <div className="mt-16 bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">عن Prima</h2>
          <p className="text-muted-foreground max-w-3xl mx-auto mb-6">
            Prima هي علامة تجارية إيطالية ذات تاريخ عريق في تصنيع أدوات الكتابة والقرطاسية الفاخرة.
            تشتهر منتجاتها بالجودة الفائقة والتصميم الأنيق والدقة الإيطالية.
            تتميز أقلام الرصاص من Prima باستخدام خشب الصنوبر الفاخر ورصاص نقي يوفر تجربة كتابة ورسومات استثنائية.
          </p>
...
export default PrimaPencilsPage;

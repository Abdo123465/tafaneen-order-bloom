...
const KashakilSilkA5_60PagesPage = () => {
  const { addToCart } = useCart();
  const { toast } = useToast();

  useEffect(() => {
    document.title = "كشاكيل سلك A5 - 60 ورقة | تفانين";
    const desc = "كشاكيل سلك بحجم A5 - 60 ورقة بأنواع مختلفة";
  ...
  const products = [
    {
      id: 1,
      name: "كشكول سلك عربي 60ق A5",
      price: 35,
      image: "/assets/kashakil-silk-a5-60-arabic.jpg",
      type: "arabic",
      description: "كشكول سلك بحجم A5 بسطور عربية - 60 ورقة"
    },
    {
      id: 2,
      name: "كشكول سلك A5 إنجليزي - 60 ورقة",
      price: 40,
      image: "/assets/kashakil-silk-a5-60-english.jpg",
      type: "english",
      description: "كشكول سلك بحجم A5 بسطور إنجليزية - 60 ورقة"
    },
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل سلك A5 - 60 ورقة</h1>
            <p className="text-muted-foreground mb-8">
              مجموعة متنوعة من كشاكيل السلك بحجم A5 بـ 60 ورقة
            </p>
          </div>
...
export default KashakilSilkA5_60PagesPage;

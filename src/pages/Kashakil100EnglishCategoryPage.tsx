// src/pages/Kashakil100EnglishCategoryPage.tsx
...
const Kashakil100EnglishCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 100 ورقة انجليزي | تفانين";
    const desc = "اختر كشكول انجليزي 100 ورقة المناسب لك من مجموعة متنوعة من الأنواع.";
  ...
  const notebookTypes = [
    {
      id: 1,
      name: "كراسات عادية",
      description: "كشاكيل انجليزي 100 ورقة بأغلفة بسيطة وأسعار اقتصادية",
      icon: Languages,
      color: "bg-gradient-to-br from-blue-500 to-blue-600",
      textColor: "text-blue-600",
      link: "/notebooks/kashakil/100-pages/english/normal"
    },
    {
      id: 2,
      name: "كراسات ديزني",
      description: "كشاكيل انجليزي 100 ورقة بتصاميم ديزني المحببة للأطفال",
      icon: Languages,
      color: "bg-gradient-to-br from-purple-500 to-purple-600",
      textColor: "text-purple-600",
      link: "/notebooks/kashakil/100-pages/english/disney"
    }
  ];
        ...
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            <nav className="text-sm text-muted-foreground mb-4">
              ...
              <span className="mx-2">/</span>
              <span>كراسة انجليزي</span>
            </nav>
            
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل 100 ورقة انجليزي</h1>
...
export default Kashakil100EnglishCategoryPage;

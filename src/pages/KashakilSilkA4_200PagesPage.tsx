...
const KashakilSilkA4_200PagesPage = () => {
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل سلك A4 - 200 ورقة</h1>
            <p className="text-muted-foreground mb-8">
              مجموعة متنوعة من كشاكيل السلك بحجم A4 بـ 200 ورقة
            </p>
          </div>
...
export default KashakilSilkA4_200PagesPage;

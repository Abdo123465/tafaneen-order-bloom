// src/pages/Kashakil80ArabicCategoryPage.tsx
...
const Kashakil80ArabicCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 80 ورقة عربي | تفانين";
    const desc = "اختر بين كشاكيل عربي 80 ورقة عادي أو ديزني.";
  ...
  const categories = [
    {
      ...
      icon: BookOpen,
      path: "/notebooks/kashakil/80-pages/arabic/normal",
    ...
    },
    {
      ...
      icon: Sparkles,
      path: "/notebooks/kashakil/80-pages/arabic/disney",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-foreground">كراسة عربي</span>
        </nav>

        <div className="text-center mb-12">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 80 ورقة عربي</h1>
...
export default Kashakil80ArabicCategoryPage;

...
const kashakil100ArabicNormalItems = [
  {
    id: "kash100-arb-nor-1",
    name: "كشكول 100 ورقة عربي عادي",
    price: 15,
    image: "/assets/kash100-arb-nor-blue.jpg",
    description: "كشكول عربي 100 ورقة، غلاف أزرق بسيط، ورق 60 جرام.",
    brand: "محلي",
    pages: 100,
    size: "22×16 سم",
    paperWeight: "60 جرام",
  ...
  {
    id: "kash100-arb-nor-2",
    name: "كشكول 100 ورقة عربي عادي",
    price: 15,
    image: "/assets/kash100-arb-nor-red.jpg",
    description: "كشكول عربي 100 ورقة، غلاف أحمر بسيط، ورق 60 جرام.",
    brand: "محلي",
    pages: 100,
    size: "22×16 سم",
    paperWeight: "60 جرام",
  ...
  {
    id: "kash100-arb-nor-3",
    name: "كشكول 100 ورقة عربي عادي",
    price: 15,
    image: "/assets/kash100-arb-nor-green.jpg",
    description: "كشكول عربي 100 ورقة، غلاف أخضر بسيط، ورق 60 جرام.",
    brand: "محلي",
    pages: 100,
    size: "22×16 سم",
    paperWeight: "60 جرام",
...
const Kashakil100ArabicNormalPage = () => {
  ...
  useEffect(() => {
    ...
    const desc = "كشاكيل عربي 100 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            كشاكيل عربي اقتصادية بأغلفة بسيطة ومناسبة للاستخدام اليومي
          </p>
        </div>

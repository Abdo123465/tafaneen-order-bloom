// src/pages/Kashakil60ArabicCategoryPage.tsx
...
const Kashakil60ArabicCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 60 ورقة عربي | تفانين";
    const desc = "اختر بين كشاكيل عربي عادي أو ديزني - 60 ورقة.";
  ...
  const categories = [
    {
      ...
      path: "/notebooks/kashakil/60-pages/arabic/normal"
    },
    {
      id: 2,
      name: "ديزني",
      ...
      path: "/notebooks/kashakil/60-pages/arabic/disney"
    }
  ];
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل 60 ورقة - كراسة عربي</h1>
...
export default Kashakil60ArabicCategoryPage;

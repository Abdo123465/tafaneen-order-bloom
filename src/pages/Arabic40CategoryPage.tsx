...
const Arabic40CategoryPage = () => {
  useEffect(() => {
    document.title = "كراسات عربي 40 ورقة | تفانين";
  }, []);
  ...
  const categories = [
    {
      ...
      link: "/notebooks/krassat/40-pages/arabic-normal"
    },
    {
      id: "disney",
      name: "كراسات ديزني",
      ...
      link: "/notebooks/krassat/40-pages/arabic-disney"
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
          ...
          <ArrowRight className="h-4 w-4" />
          <span className="text-foreground">عربي</span>
        </nav>

        <div className="text-center mb-12">
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسات عربي – 40 ورقة</h1>
...
export default Arabic40CategoryPage;

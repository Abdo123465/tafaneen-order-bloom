...
const English40LinesPage = () => {
  useEffect(() => {
    document.title = "كراسة 9 أسطر 40 ورقة | تفانين";
    const desc = "اختر كراسة 9 أسطر 40 ورقة - ديزني أو عادي";
  ...
  const notebookTypes = [
    {
      ...
      path: "/notebooks/krassat/40-pages/english/9-lines/disney",
    ...
    },
    {
      ...
      path: "/notebooks/krassat/40-pages/english/9-lines/normal",
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كراسة 9 أسطر - 40 ورقة</h1>
...
export default English40LinesPage;

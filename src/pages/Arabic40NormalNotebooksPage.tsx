// src/pages/Arabic40NormalNotebooksPage.tsx
...
const Arabic40NormalNotebooksPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كراسات عربي عادي 40 ورقة | تفانين";
    const desc = "كراسات عربي 40 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كراسات عربي عادي – 40 ورقة</h1>
...
export default Arabic40NormalNotebooksPage;

// src/pages/Kashakil60ArabicDisneyPage.tsx
...
const kashakil60ArabicDisneyItems = [
  {
    id: "kash60-ar-dis-1",
...
const Kashakil60ArabicDisneyPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة عربي ديزني | تفانين";
    const desc = "احصل على كشاكيل العربي 60 ورقة بتصاميم ديزني المميزة.";
      ...
      >
        <main className="container mx-auto px-4 py-10">
          ...
          <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <Link to="/notebooks/kashakil/60-pages/arabic" className="hover:text-primary">كراسة عربي</Link>
            <ArrowRight className="h-4 w-4" />
            <span className="text-foreground">ديزني</span>
          </nav>

          {/* نفس شكل عربي ديزني تمامًا */}
          <div className="text-center mb-12">
            ...
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة عربي ديزني</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kashakil60ArabicDisneyItems.map((item) => (
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline">
              <Link to="/notebooks/kashakil/60-pages/arabic">العودة إلى كراسة عربي</Link>
            </Button>
          </div>
        </main>
      </div>
...
export default Kashakil60ArabicDisneyPage;

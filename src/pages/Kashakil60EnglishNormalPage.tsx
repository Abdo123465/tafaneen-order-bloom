// src/pages/Kashakil60EnglishNormalPage.tsx
...
const kashakil60EnglishNormalItems = [
  {
    id: "kash60-en-nor-1",
    name: "كشكول 60 ورقة إنجليزي عادي",
    price: 12,
    image: "/assets/kash60-en-nor-blue.jpg",
    description: "كشكول إنجليزي 60 ورقة، غلاف لامع بسيط، ورق 60 جرام.",
    brand: "محلي",
    pages: 60,
    size: "15×21 سم",
    paperWeight: "56 جرام",
...
const Kashakil60EnglishNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة إنجليزي عادي | تفانين";
    const desc = "كشاكيل إنجليزي 60 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة إنجليزي عادي</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil60EnglishNormalItems.map((item) => (
...
export default Kashakil60EnglishNormalPage;

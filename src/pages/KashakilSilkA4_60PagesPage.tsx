...
const KashakilSilkA4_60PagesPage = () => {
  const { addToCart } = useCart();
  const { toast } = useToast();

  useEffect(() => {
    document.title = "كشاكيل سلك A4 - 60 ورقة | تفانين";
    const desc = "كشاكيل سلك بحجم A4 - 60 ورقة بأنواع مختلفة";
  ...
  const products = [
    ...
    {
      id: 3,
      name: "كشكول سلك A4 مربعات صغيرة - 60 ورقة",
      price: 25,
      image: "/assets/kashakil-silk-a4-60-small-squares.jpg",
      type: "small-squares",
      description: "كشكول سلك بحجم A4 بمربعات صغيرة - 60 ورقة"
    },
    {
      id: 4,
      name: "كشكول سلك A4 صفحة بصفحة - 60 ورقة",
      price: 25,
      image: "/assets/kashakil-silk-a4-60-page-by-page.jpg",
      type: "page-by-page",
      description: "كشكول سلك بحجم A4 صفحة بصفحة - 60 ورقة"
    }
  ];
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل سلك A4 - 60 ورقة</h1>
            <p className="text-muted-foreground mb-8">
              مجموعة متنوعة من كشاكيل السلك بحجم A4 بـ 60 ورقة
            </p>
          </div>
...
export default KashakilSilkA4_60PagesPage;

// src/pages/Kashakil60NineLinesCategoryPage.tsx
...
const Kashakil60NineLinesCategoryPage = () => {
  useEffect(() => {
    document.title = "كشاكيل 60 ورقة 9 أسطر | تفانين";
    const desc = "اختر بين كشاكيل 9 أسطر عادي أو ديزني - 60 ورقة.";
  ...
  const categories = [
    {
      ...
      path: "/notebooks/kashakil/60-pages/9-lines/normal"
    },
    {
      id: 2,
      name: "ديزني",
      ...
      path: "/notebooks/kashakil/60-pages/9-lines/disney"
    }
  ];
      ...
      <main>
        <section className="container mx-auto px-4 py-10">
          <div className="mb-8">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold mb-4">كشاكيل 60 ورقة - كراسة 9 أسطر</h1>
...
export default Kashakil60NineLinesCategoryPage;

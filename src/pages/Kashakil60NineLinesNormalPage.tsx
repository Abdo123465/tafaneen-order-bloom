// src/pages/Kashakil60NineLinesNormalPage.tsx
...
const kashakil60NineLinesNormalItems = [
  {
    id: "kash60-9l-nor-1",
    name: "كشكول 56 ورقة 9 أسطر عادي",
    price: 16,
    image: "/assets/kash60-9l-nor-blue.jpg",
    description: "كشكول 9 أسطر 60 ورقة، غلاف لامع بسيط، ورق 48 جرام.",
    brand: "محلي",
    pages: 60,
    size: "21×15 سم",
    paperWeight: "48 جرام",
...
const Kashakil60NineLinesNormalPage = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كشاكيل 60 ورقة 9 أسطر عادي | تفانين";
    const desc = "كشاكيل 9 أسطر 60 ورقة بأغلفة بسيطة وأسعار اقتصادية.";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          ...
          />
          <h1 className="text-3xl lg:text-4xl font-bold mb-4">كشاكيل 60 ورقة 9 أسطر عادي</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {kashakil60NineLinesNormalItems.map((item) => (
...
export default Kashakil60NineLinesNormalPage;

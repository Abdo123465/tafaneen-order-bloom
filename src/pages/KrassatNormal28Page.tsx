// src/pages/KrassatNormal28Page.tsx
...
const normal28Items = [
  {
    id: "nor-28-1",
    name: "كراسة مربعات كبيرة عادي - أزرق",
    price: 15,
    image: "/assets/normal-28-blue.jpg",
    description: "كراسة مربعات كبيرة عادية غلاف أزرق",
    brand: "محلي",
    pages: 28,
    size: "17×24 سم",
    paperWeight: "60 جرام",
  ...
  {
    id: "nor-28-2",
    name: "كراسة مربعات كبيرة عادي - أحمر",
    price: 15,
    image: "/assets/normal-28-red.jpg",
    description: "كراسة مربعات كبيرة عادية غلاف أحمر",
    brand: "محلي",
    pages: 28,
    size: "17×24 سم",
    paperWeight: "60 جرام",
...
const KrassatNormal28Page = () => {
  const { addItem } = useCart();

  useEffect(() => {
    document.title = "كراسة مربعات كبيرة عادي | تفانين";
    const desc = "احصل على كراسات مربعات كبيرة عادية بألوان مختلفة.";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/assets/normal-bg.jpg')" }}
      >
        <main className="container mx-auto px-4 py-10">
          <nav className="flex items-center gap-2 text-sm text-white/80 mb-8">
            ...
            <ArrowRight className="h-4 w-4" />
            <span className="text-white font-medium">مربعات كبيرة عادي</span>
          </nav>

          <div className="text-center mb-12">
            <img
              src="/assets/normal-28-banner.jpg"
              alt="Normal 28 Notebooks"
              className="mx-auto h-40 object-cover rounded-xl mb-4 shadow"
              onError={(e) => (e.currentTarget.src = "https://via.placeholder.com/600x160?text=Normal+28+Notebooks")}
            />
            <h1 className="text-3xl lg:text-4xl font-bold mb-4 text-white drop-shadow">كراسة مربعات كبيرة عادي</h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto drop-shadow">كراسات مربعات كبيرة عادية بألوان مختلفة</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {normal28Items.map((item) => (
...
export default KrassatNormal28Page;
